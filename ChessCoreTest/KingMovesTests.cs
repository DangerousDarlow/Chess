...
public class KingMovesTests : MovesTests
{
    ...
    [Test]
    public void Castling_is_not_possible_if_castling_availability_in_board_state_is_not_true()
    {
        var board = Board.CreateFromForsythEdwardsNotation("r3k2r/8/8/8/8/8/8/R3K2R w - - 0 1");
        var moves = MoveCalculator.GetMovesForColour(board, Colour.White);
        moves.AddRange(MoveCalculator.GetMovesForColour(board, Colour.Black));
